                ...
                <div class="cart__inner">
                    ...
                    <div class="cart__items">
                        ...
                        <div class="cart__item">
                            ...
                            <div class="cart__item-price">
                                ...
                                <div class="cart__item-indicator cart__item-indicator--error"></div>
                            </div>
                            <div class="cart__item-amount"> 
                                <div class="cart__item-control cart__item-control--error">
                                    <button class="cart__item-minus disable">-</button>
                                    <span class="cart__item-num ">1</span>
                                    <button class="cart__item-plus cart__item-plus--error">+</button>
                                </div>
                            </div>
                    ...
                    <div class="cart-nav">
                        ...
                        <div class="cart__error">
                            <svg xmlns="http://www.w3.org/2000/svg" width="408.48" height="374.83" viewBox="0 0 408.48 374.83">
                                <style type="text/css">
                                    .st0{fill:#fd5a5a;}
                                </style>
                            ...
                            <div class="cart__error-message">
                                <p>Некоторых товаров нет в наличии или недостаточно на складе.</p>
                                <p>Уменьшите кол-во или уберите данный товар из корзины для оформления заказа.</p>
                            </div>
                        </div>
                    </div>
                </div>
