        ...
        <div class="site__nav">
            <div class="container">
                <div class="breadcrumbs">
					...
					<span class="breadcrumbs__item"><a href="accii.php">Пищевые красители</a></span>
					<span class="breadcrumbs__item"><a href="accii.php">Жидкие красители</a></span>
					<span class="breadcrumbs__item"><a href="accii.php">Форма для выпечки со съемным дном Caramella розовая КРУГ 26 см</a></span>
			...
			<div class="container">
				<div class="catalog-list__inner">
					<aside class="">
						<div class="catalog-menu">
							<div class="catalog-menu__top">
								<svg xmlns="http://www.w3.org/2000/svg"
									...
									d="M1.6405945,1.9999084 C1.6405945,1.9999084 15.3594055,1.9999084 15.3594055,1.9999084 C15.713211,1.9999084 15.999985,2.2867432 15.999985,2.640625 C15.999985,2.9945068 15.713211,3.281311 15.3594055,3.281311 C15.3594055,3.281311 1.6405945,3.281311 1.6405945,3.281311 C1.286789,3.281311 1.0000153,2.9945068 1.0000153,2.640625 C1.0000153,2.2867432 1.286789,1.9999084 1.6405945,1.9999084 ZM1.6428833,6.8437195 C1.6428833,6.8437195 15.357117,6.8437195 15.357117,6.8437195 C15.712158,6.8437195 15.999985,7.131653 15.999985,7.486664 C15.999985,7.486664 15.999985,7.5134583 15.999985,7.5134583 C15.999985,7.868469 15.712158,8.1562195 15.357117,8.1562195 C15.357117,8.1562195 1.6428833,8.1562195 1.6428833,8.1562195 C1.2878418,8.1562195 1.0000153,7.868469 1.0000153,7.5134583 C1.0000153,7.5134583 1.0000153,7.486664 1.0000153,7.486664 C1.0000153,7.131653 1.2878418,6.8437195 1.6428833,6.8437195 ZM1.6405945,11.718811 C1.6405945,11.718811 15.3594055,11.718811 15.3594055,11.718811 C15.713211,11.718811 15.999985,12.005615 15.999985,12.359314 C15.999985,12.713196 15.713211,13.0 15.3594055,13.0 C15.3594055,13.0 1.6405945,13.0 1.6405945,13.0 C1.286789,13.0 1.0000153,12.713196 1.0000153,12.359314 C1.0000153,12.005615 1.286789,11.718811 1.6405945,11.718811 Z"/>
								</svg>
									...
									<li class="catalog-menu__item">
										...
										<ul class="catalog-menu__hidden">
											...
											<li>
												<a href="#">
													<i class="fa fa-caret-right" aria-hidden="true"></i>
													<span>Гелевые красители жирорастворимые</span>	
												</a>
											</li>
										</ul>
									</li> 
									...
									<li class="catalog-menu__item">
										<div class="catalog-menu__show">
											...
											<svg id="Слой_1" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.14 22.86"><defs><style>.cls-1{fill:#3b395e;}</style></defs><path class="cls-1" d="M306.54,421.07v-3.55a2.56,2.56,0,0,0,1-1.21l0-2.35a1.9,1.9,0,0,0-1.4-1.77h-5.32a3.09,3.09,0,0,0-.71-2,3,3,0,0,0-4.07,0,3,3,0,0,0-.65,2H290a1.77,1.77,0,0,0-1.66,1.75v3l.2.15a5,5,0,0,0,1,.48v3.48h-3l0,.53c0,.37.5,3.36,8.78,4.13l1,2.85a4.17,4.17,0,0,0-2.69,3.05l-.09.58h9l-.09-.58a4.2,4.2,0,0,0-2.69-3.05l1-2.85c8.28-.77,8.75-3.76,8.78-4.13l0-.53Zm-9.72-10.26a1.62,1.62,0,0,1,1.28-.47,1.68,1.68,0,0,1,1.3.48,2.08,2.08,0,0,1,.45,1.36h-3.43A2.09,2.09,0,0,1,296.82,410.81Zm-7.5,3.16c0-.08.11-.8.67-.8h16a.88.88,0,0,1,.62.79V416a1.35,1.35,0,0,1-.62.66,10,10,0,0,1-2.63-.3,4.41,4.41,0,0,0-1.41-1.15l-.11-.06h-3.91a1.07,1.07,0,0,0-.84.34,1,1,0,0,0-.24.76v2.18s-.1.64-.4.64a1.18,1.18,0,0,1-.77-.35v-1.48c0-1.76-.75-1.93-2-2.07a2,2,0,0,0-1.86.75,6.67,6.67,0,0,1-.7.64,1,1,0,0,1-.57.17v-.07H290a2.78,2.78,0,0,1-.66-.28Zm1.17,3.8a1.88,1.88,0,0,0,1.18-.38,7.9,7.9,0,0,0,.8-.72c.39-.41.51-.53,1.07-.46,1.08.12,1.1.12,1.1,1.07v1.83l.1.13a2.23,2.23,0,0,0,1.67.87c1,0,1.33-1,1.4-1.58l0-2.33h3.75a3.53,3.53,0,0,1,.94.75c.1.19.36.66,3.06.75v3.38H290.49Zm10.83,13.44h-6.49a3.71,3.71,0,0,1,6.49,0Zm-2.49-2.86a5.71,5.71,0,0,0-.73-.05h-.05a5.58,5.58,0,0,0-.73.05l-.91-2.54c.53,0,1.07.06,1.66.08h0c.59,0,1.13,0,1.66-.08Zm-.76-3.46c-7.38-.21-9.6-1.93-10.26-2.82h20.53C307.67,423,305.45,424.68,298.07,424.89Z" transform="translate(-286.5 -409.34)"/></svg>
												<span>Бумажные формы и капсулы</span>
											</div>
											<i class="fa fa-caret-right" aria-hidden="true"></i>
										</div>
										<ul class="catalog-menu__hidden">
						...
						<div class="catalog-list__banner">
							БАННЕРНОЕ МЕСТО <br>
							ДЛЯ КАТАЛОГА
						</div>
						<div class="catalog-list__news">
							<p class="catalog-list__news-title">СВЕЖИЕ НОВОСТИ</p>
							<div class="catalog-list__news-items">
								<div class="ournews__item events">
									<p class="events__date">05.04.2021</p>
									<h3 class="events__title">Открытие нового магазина в Уссурийске</h3>
									<a href="" class="events__link">подробнее</a>
								</div>
								<div class="ournews__item events">
									<p class="events__date">03.04.2021</p>
									<h3 class="events__title">Поступление новых пищевых красок в наш ассортимент</h3>
									<a href="" class="events__link">подробнее</a>
								</div>
								<div class="ournews__item events">
									<p class="events__date">22.03.2021</p>
									<h3 class="events__title">График работы на майские праздники</h3>
									<a href="" class="events__link">подробнее</a>
								</div>
							</div>
							<a href="news.php" class="catalog-list__news-all">архив новостей</a>
						</div>
					...
					<main>
						<div class="catalog-detail">
							...
							<h2 class="catalog-detail__title">Форма для выпечки со съемным дном Caramella розовая КРУГ 26 см</h2>

							<div class="catalog-detail__sides">
								<div class="catalog-detail__gallery">
									
									<div class="tabs">
									
										<!-- Большие картинки -->
										<div class="tabs__content tabs__content--active" data-tabs-target="1">
											<img src="images/new.png" alt="" class="catalog-detail__new">
											<img src="images/catalog_item1.jpg" alt="">
											<img src="images/magnifier.png" alt="" class="catalog-detail__magnifier">
										</div>
										<div class="tabs__content" data-tabs-target="2">
											<img src="images/new.png" alt="" class="catalog-detail__new">
											<img src="images/catalog_item2.jpg" alt="">
											<img src="images/magnifier.png" alt="" class="catalog-detail__magnifier">
										</div>
										<div class="tabs__content" data-tabs-target="3">
											<img src="images/new.png" alt="" class="catalog-detail__new">
											<img src="images/catalog_item3.jpg" alt="">
											<img src="images/magnifier.png" alt="" class="catalog-detail__magnifier">
										</div>
										<div class="tabs__content" data-tabs-target="4">
											<img src="images/new.png" alt="" class="catalog-detail__new">
											<img src="images/catalog_item4.jpg" alt="">
											<img src="images/magnifier.png" alt="" class="catalog-detail__magnifier">
										</div>
										<div class="tabs__content" data-tabs-target="5">
											<img src="images/new.png" alt="" class="catalog-detail__new">
											<img src="images/catalog_item5.jpg" alt="">
											<img src="images/magnifier.png" alt="" class="catalog-detail__magnifier">
										</div>
										...
										<ul class="tabs__list">
											<!-- Маленькие картинки -->
											<li class="tabs__item tabs__item--active" data-tabs-path="1">
												<img src="images/catalog_item1.jpg" alt="">
											</li>
											<li class="tabs__item" data-tabs-path="2">
												<img src="images/catalog_item2.jpg" alt="">
											</li>
											<li class="tabs__item" data-tabs-path="3">
												<img src="images/catalog_item3.jpg" alt="">
											</li>
											<li class="tabs__item" data-tabs-path="4">
												<img src="images/catalog_item4.jpg" alt="">
											</li>
											<li class="tabs__item" data-tabs-path="5">
												<img src="images/catalog_item5.jpg" alt="">
											</li>
								...
								<div class="catalog-detail__side">
									<div class="catalog-detail__info">
										<p>
											<span class="catalog-detail__info-title">Бренд:</span>
											<strong class="catalog-detail__info-value">Caramella</strong>
										</p>
										<p>
											<span class="catalog-detail__info-title">Страна:</span>
											<strong class="catalog-detail__info-value">Италия</strong>
										</p>
										<p>
											<span class="catalog-detail__info-title">Размер:</span>
											<strong class="catalog-detail__info-value">26 см</strong>
										</p>
										<p>
											<span class="catalog-detail__info-title">Артикул:</span>
											<strong class="catalog-detail__info-value">601804</strong>
										</p>
											
											
									</div>
									<div class="catalog-detail__desc">
										<p>Форма круглая для выпечки со съемным дном очень удобна в использовании, готовый продукт без труда извлекается из формы. Имеет антипригарное покрытие, значительно превосходящее обыкновенное.</p>
										<a href="#">подробнее</a>
									</div>
									<div class="catalog-detail__nav">
										<button class="catalog-detail__favorite">
										...
										<button class="catalog-detail__question">
						...
						<div class="catalog-detail__tabs tabs">
							<ul class="tabs__items">
								<li class="tabs__item tabs__item--active" data-tabs-path="desc">ОПИСАНИЕ                              </li>
								<li class="tabs__item" data-tabs-path="howbuy">КАК КУПИТЬ</li>
								<li class="tabs__item" data-tabs-path="pay">ОПЛАТА</li>
								<li class="tabs__item" data-tabs-path="delivery">ДОСТАВКА</li>
							</ul>
							<div class="tabs__content tabs__content--active text" data-tabs-target="desc">
								dds
							...
							<div class="tabs__content text" data-tabs-target="howbuy">
								11
								<p class="p">Форма круглая для выпечки со съемным дном очень <span>удобна в использовании</span>, готовый продукт без труда извлекается из формы. Имеет антипригарное покрытие, значительно превосходящее обыкновенное.</p>
								<h2 class="h2">Внутренний подзаголовок h2 для примера</h2>
								<p class="p">Твердость двумерно иллюстрирует конструктивный фраджипэн, что было отмечено П.Лазарсфельдом. Чернозём по определению охлаждает прагматический постиндустриализм. Идеология вероятна. Элемент политического процесса, вследствие пространственной неоднородности почвенного покрова, восстанавливает экзистенциальный бихевиоризм, что дает возможность использования данной методики как универсальной.</p>
							...
							<div class="tabs__content text" data-tabs-target="pay">
								12
								<p class="p">Форма круглая для выпечки со съемным дном очень <span>удобна в использовании</span>, готовый продукт без труда извлекается из формы. Имеет антипригарное покрытие, значительно превосходящее обыкновенное.</p>
								<h2 class="h2">Внутренний подзаголовок h2 для примера</h2>
								<p class="p">Твердость двумерно иллюстрирует конструктивный фраджипэн, что было отмечено П.Лазарсфельдом. Чернозём по определению охлаждает прагматический постиндустриализм. Идеология вероятна. Элемент политического процесса, вследствие пространственной неоднородности почвенного покрова, восстанавливает экзистенциальный бихевиоризм, что дает возможность использования данной методики как универсальной.</p>
							...
							<div class="tabs__content text" data-tabs-target="delivery">
								13
								<p class="p">Форма круглая для выпечки со съемным дном очень <span>удобна в использовании</span>, готовый продукт без труда извлекается из формы. Имеет антипригарное покрытие, значительно превосходящее обыкновенное.</p>
								<h2 class="h2">Внутренний подзаголовок h2 для примера</h2>
								<p class="p">Твердость двумерно иллюстрирует конструктивный фраджипэн, что было отмечено П.Лазарсфельдом. Чернозём по определению охлаждает прагматический постиндустриализм. Идеология вероятна. Элемент политического процесса, вследствие пространственной неоднородности почвенного покрова, восстанавливает экзистенциальный бихевиоризм, что дает возможность использования данной методики как универсальной.</p>
						...
						<section class="new">
							<div class="new__inner">
								<h2 class="new__title">С этим товаром покупают</h2>
